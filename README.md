...
| `steam_mobile_confirm_required` | Steam просит подтверждение в приложении | нет |
...
* Steam Guard берётся только из maFile. Экраны «код на почту» и «подтвердите в приложении»
  детектируются и дают отдельные статусы, но не автоматизируются.
