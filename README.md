...
прохождение мастера Onboard целиком: согласия, почта с токеном из письма в Outlook и
трейд-ссылка, которую бот берёт со страницы обменов Steam (`csfloat.fill_trade_link`).
