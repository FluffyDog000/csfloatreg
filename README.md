...
финальный URL, заголовок, размер HTML, длину видимого текста, отрисовалось ли вообще
что-нибудь. Упавшие запросы и JS-ошибки идут в лог, скриншот и HTML — в `debug/<login>/`.
